...
export default defineNuxtConfig({
  ...
  app: {
    head: {
      ...
      title: 'Seraphin Haeuptli', // App window nav title
      meta: [
        { charset: 'utf-8' },
        { name: 'viewport', content: 'width=device-width, initial-scale=1' },
        { hid: 'description', name: 'description', content: 'Seraphin Haeuptli, Junior Developer based in Switzerland' },
      ...
      link: [
        { rel: 'icon', type: 'public/x-icon', href: 'pwa/icons/favicon.ico' },
        { rel: 'manifest', href: 'pwa/icons/site.webmanifest' },
